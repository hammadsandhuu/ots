...
interface ServiceDetailsTwoPriceProps {
    service: ServiceDetailData;
}

const ServiceDetailsTwoPrice = ({ service }: ServiceDetailsTwoPriceProps) => {
    const displayPricingData = service.pricingPlans ?? pricePlans.slice(12, 15);
