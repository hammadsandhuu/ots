...
export const metadata: Metadata = {
  title: "OTS - Ocean Trading Services | Logistics & Supply Chain",
  description: "Ocean Trading Services - Premier logistics and supply chain solutions across Saudi Arabia and beyond.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="no-js ots-light" suppressHydrationWarning={true}>
