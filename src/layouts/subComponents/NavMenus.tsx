  ...
  return (
    <ul>
      {headerMenuData.map((menu) => {
        const hasDropdownContent = menu.hasDropdown || menu.megaMenu || menu.smallMenu || menu.mediumMenu || (menu.submenus && menu.submenus.length > 0);
        
        return (
        <li
          key={menu.id}
          className={`${hasDropdownContent ? 'has-dropdown' : ''} ${menu.megaMenu || menu.smallMenu || menu.mediumMenu ? "p-static" : ""
