                    ...
                    <div className="col-lg-6">
                        <div className="dgm-about-right">
                            <div className="dgm-about-title-box z-index-1 mb-35">
                                <span className="tp-section-subtitle subtitle-black mb-15 tp_fade_anim" data-delay=".3">About OTS-KSA</span>
...
With over 100 years of experience, we provide comprehensive logistics solutions for companies around the world. Our global network of partners ensures seamless, efficient transport services across the globe.
                                ...
                                <div className="tp_fade_anim" data-delay=".5">
                                    <Link className="tp-btn-secondary green-solid btn-60 mb-50" href="/about-us-light">
                                        <span>
