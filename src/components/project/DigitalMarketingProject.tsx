                    ...
                    <div className="row align-items-end">
                        ...
                        <div className="col-xl-6 col-lg-6">
                            <div className="dgm-project-top-text mb-30 tp_fade_anim">
                                <p>
                                    We deliver reliable logistics solutions tailored to each client’s needs,
                                    ensuring safe transportation, timely delivery, and complete supply chain
                ...
                <div className="dgm-project-text-active fix mt-55">
                    ...
                    >
                        {projects.slice(-6).map((project) => (
                            <SwiperSlide key={`text-${project.title}`}>
                                <div className="dgm-project-item">
