...
import testBgImg from "../../../public/assets/img/home-03/testimonial/3.webp";
    ...
    const testimonials = [
        {
            id: 1,
            quoteSvg: <QuoteIcon />,
            text: "Their door-to-door delivery service is fast, reliable, and completely hassle-free. Our shipments always arrive on time and in perfect condition.",
            authorImg: authorImg,
            logo: testiLogo,
        ...
        },
        {
            id: 2,
            quoteSvg: <QuoteIcon />,
            text: "From FOB shipping to customs clearance, their team handled everything professionally. Communication was clear, and the process was smooth.",
            authorImg: authorImg,
            logo: testiLogo,
            authorName: "Sarah Williams",
            position: "Supply Chain Manager, Oceanex Ltd."
        },
        {
            id: 3,
            quoteSvg: <QuoteIcon />,
            text: "We trust them with our international freight every time. Their logistics expertise and attention to detail truly set them apart.",
            authorImg: authorImg,
            logo: testiLogo,
