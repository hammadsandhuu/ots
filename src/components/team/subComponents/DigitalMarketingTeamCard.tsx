...
const DigitalMarketingTeamCard = ({ member, index }: TeamMemberPropsDT) => {
    ...
    return (
        <div className="dgm-team-item mb-40 tp_fade_anim" data-delay={`0.${index + 3}`}>
            <div className="dgm-team-thumb tp--hover-item p-relative overflow-hidden">
                <Link href={member.link} className="block">
                    <div
                        className="tp--hover-img position-relative w-100"
